...
def main(algo, nb_games_to_win, txt_to_read, n_test, Verbose=False, sup=18, new_winning_dataset = False, txt = 'how_to_win.csv'): #new_winning_dataset = True if the dataset has not been generated yet
...
results = main(algo='random', nb_games_to_win = 200000, txt = 'how_to_win_replacement.csv', txt_to_read = 'how_to_win_replacement.csv', n_test = 20000)
